...
if __name__ == "__main__":
    ...
    parser.add_argument('--losses_weights', '-weights', default=[1e5, 1e5, 1e3], type=float, help='Losses weights. "standard" mode -> [w_img, _, _], "parametric" mode ->[w_img_nn, w_img_mu, w_code]')
    ...
    parser.add_argument('--alpha_relu','-a_relu', default=0.5, type=float, help="initial value for the parameter of the relu activaction function. Only if any activation function = 'param_relu")
    parser.add_argument('--alpha_sigmoid','-a_sigmoid', default=0.5, type=float, help="initial value for the parameter of the sigmoid activaction function. Only if any activation function = 'param_sigmoid")
    ...
    parser.add_argument('--dropout_prob','-drop_prob', default=0.1, type=float, help="Probability of each dropout layer to deactivate its neurons in a forward pass. Only if dropout = True")
