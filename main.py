...
if __name__ == "__main__":
    ...
    parser.add_argument('--reg_coef', '-reg_coef', default=1e-10, type=float, help='coefficient that multiplies the regularisation term in the loss function')
    ...
    parser.add_argument('--alpha_relu','-a_relu', default=0.3, type=float, help="initial value for the parameter of the relu activaction function")
    parser.add_argument('--alpha_sigmoid','-a_sigmoid', default=0.3, type=float, help="initial value for the parameter of the sigmoid activaction function")
